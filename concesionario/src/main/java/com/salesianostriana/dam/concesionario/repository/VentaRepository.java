...
public interface VentaRepository extends JpaRepository<Venta, Long> {
	...
	@Query("SELECT COUNT(lv.producto.id) FROM Venta v JOIN v.listaLineaVenta lv WHERE lv.producto = :producto")
	public int countAparicionesProductosEnLineaVenta(@Param("producto") Producto producto);
}
